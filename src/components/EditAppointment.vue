    ...
    <ul>
      <li v-for="error in errors" v-bind:key="error" class="li">{{ error }}</li>
                    ...
                    <tr>
                        ...
                        <td  >
                            <input type="number" class="inputBorder"  v-model="phoneNumber" min="0" maxlength="10" minlength="10" >
                       </td>
                    </tr>
                    <tr>
                        <td>
...
console.log(currentDate);
      ...
      if (!this.startTime) {
       ...
       this.errors.push('End time cannot be less than or same as start time');
      }
 ...
 console.log(r.value);
      ...
      return re.test(email);
       ...
       updateAppointment(){
             let data = this.$route.params.appointmentToUpdate;
            
         axios.put("https://localhost:44332/api/"+"AppointmentDetails/"+data.appointmentId,{
...
this.$router.push({
 ...
 console.log(r.value);
   ...
   mounted(){
            this.title=this.$route.params.appointmentToUpdate.title;
            this.customerName=this.$route.params.appointmentToUpdate.customerName;
            this.email=this.$route.params.appointmentToUpdate.email;
            this.phoneNumber=this.$route.params.appointmentToUpdate.phoneNumber;
            this.startTime=this.$route.params.appointmentToUpdate.startTime;
            this.endTime=this.$route.params.appointmentToUpdate.endTime;                       
   }
